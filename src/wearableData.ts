export const wearableData = [
    {
        ...
        description1: "Yin and Yang, Black and White, one wave of the wings and all things are One.",
        description2: "Go west, go east, go anywhere lightly in putter pants, because the Force is with you!",
    ...
    },
    {
        ...
        description1: "Sleeve Tattoo with Flame Guitar. Do you want to be a rock star?",
        description2: "Bat wings over the eyes, cooler than vampires.",
        designer: "Designed & Created by Avatar Network",
        totalSupply: "total supply for the activity: 960",
        checked: false
    },
    {
        ...
        description1: "Grrr...Wear a tiger helmet in the Year of Tiger, be as vigorous as a tiger!",
        description2: "Robust, Fast, Powerful.",
        designer: "Designed & Created by Avatar Network",
        totalSupply: "total supply for the activity: 960",
        checked: false
    },
    {
        ...
        description1: "Rainbow Unicorn is the cutest creature in the Metaverse!",
        description2: "Cute and playful lowerbody, with artist's signature and a rainbow tail",
        designer: "Designed & Created by Avatar Network",
        totalSupply: "total supply for the activity: 960",
        checked: false
    },
