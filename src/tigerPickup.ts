...
import { playerStatus, initializeUserAddress, allPositions, totalTiger } from './playerData';
...
function generateRandomPositions() {
    ...
    for(let i = 0; i< totalTiger; i++) {
        ...
        cloneP =[ ...cloneP.slice(0, randomIndex), ...cloneP.slice(randomIndex +1 ) ]
...
async function initializePositions() {
    ...
    log("The player status has been initialized", playerStatus.address, positions);
